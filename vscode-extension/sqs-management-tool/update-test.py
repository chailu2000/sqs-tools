...
# Read the file
with open('tests/e2e/specs/message-operations.test.ts', 'r') as f:
    content = f.read()
...
# Write back
with open('tests/e2e/specs/message-operations.test.ts', 'w') as f:
    f.write(content)

print("Updated message-operations.test.ts")
