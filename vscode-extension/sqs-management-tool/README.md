...
![Queue Information](https://raw.githubusercontent.com/chailu2000/sqs-tools/extension/vscode-extension/sqs-management-tool/images/queue-info.png)

### Message Composer
Send messages with custom attributes supporting all AWS SQS data types.

![Message Composer](https://raw.githubusercontent.com/chailu2000/sqs-tools/extension/vscode-extension/sqs-management-tool/images/message-composer.png)

### Message Details
View complete message details including body, attributes, and metadata.

![Message Details](https://raw.githubusercontent.com/chailu2000/sqs-tools/extension/vscode-extension/sqs-management-tool/images/message-details.png)

### DLQ Redrive
Move messages from Dead Letter Queues back to source queues with progress tracking.

![DLQ Redrive](https://raw.githubusercontent.com/chailu2000/sqs-tools/extension/vscode-extension/sqs-management-tool/images/dlq-redrive.png)
