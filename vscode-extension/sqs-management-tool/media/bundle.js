...
(function() {
  ...
  const api = {
     ...
     */
    async sendMessage(queueId, body, attributes, delaySeconds) {
  ...
  var root_5$1 = /* @__PURE__ */ from_html(`<div class="error svelte-1j1skn0"> </div>`);
  ...
  var root_1 = /* @__PURE__ */ from_html(`<div class="attributes-list svelte-5a3nm6"></div>`);
  var root_3$2 = /* @__PURE__ */ from_html(`<div class="error svelte-5a3nm6"> </div>`);
  var root_4$1 = /* @__PURE__ */ from_html(`<div class="success svelte-5a3nm6"> </div>`);
  ...
  function MessageComposerExtension($$anchor, $$props) {
    ...
    async function sendMessage() {
      ...
      try {
        ...
        const result = await api.sendMessage(store.selectedQueue.id, get(messageBody), messageAttributes, get(delaySeconds));
    ...
    var node = sibling(div_4, 2);
    {
      var consequent = ($$anchor2) => {
        var div_5 = root_1();
        each(div_5, 21, () => get(attributes), (attr) => attr.id, ($$anchor3, attr, $$index) => {
          var div_6 = root_2$2();
          ...
          template_effect(() => set_attribute(input_3, "placeholder", get(attr).dataType === "Number" || get(attr).dataType === "Number.int" || get(attr).dataType === "Number.float" ? "Value (number)" : get(attr).dataType === "Binary" ? "Value (base64)" : "Value"));
          bind_value(input_2, () => get(attr).key, ($$value) => get(attr).key = $$value);
          bind_select_value(select, () => get(attr).dataType, ($$value) => get(attr).dataType = $$value);
          bind_value(input_3, () => get(attr).value, ($$value) => get(attr).value = $$value);
      ...
      if_block(node, ($$render) => {
        if (get(attributes).length > 0) $$render(consequent);
      });
    }
    ...
    var node_2 = sibling(node_1, 2);
    {
      ...
      if_block(node_2, ($$render) => {
        if (get(success)) $$render(consequent_2);
      });
    }
  ...
  var root_17 = /* @__PURE__ */ from_html(`<div class="attribute svelte-ih63xe"><span class="attr-key svelte-ih63xe"> </span> <span class="attr-value svelte-ih63xe"> </span></div>`);
  var root_16 = /* @__PURE__ */ from_html(`<div class="detail-row svelte-ih63xe"><strong class="svelte-ih63xe">Message Attributes:</strong> <div class="attributes svelte-ih63xe"></div></div>`);
          ...
          var consequent_13 = ($$anchor3) => {
            ...
            var node_13 = sibling(div_30, 2);
            {
              var consequent_12 = ($$anchor4) => {
                ...
                each(div_32, 21, () => Object.entries(get(selectedMessage).messageAttributes), index, ($$anchor5, $$item) => {
                  var $$array = /* @__PURE__ */ user_derived(() => to_array(get($$item), 2));
                  let key = () => get($$array)[0];
                  let value = () => get($$array)[1];
                  var div_33 = root_17();
                  var span_4 = child(div_33);
                  var text_22 = child(span_4);
                  var span_5 = sibling(span_4, 2);
                  var text_23 = child(span_5);
                  template_effect(() => {
                    set_text(text_22, `${key() ?? ""}:`);
                    set_text(text_23, value().stringValue || value().binaryValue || "N/A");
                  });
