...
const sqs_service_1 = require("../../../src/services/sqs-service");
...
describe('SQSService - Redrive Operations', () => {
    ...
    let mockClient;
    beforeEach(() => {
        mockClient = new client_sqs_1.SQSClient({});
        service = new sqs_service_1.SQSService(mockClient);
    });
...
//# sourceMappingURL=sqs-service-redrive.test.js.map